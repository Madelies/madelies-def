        ...
        <div class="container d-flex justify-content-between">
            ...
            <div class="logo">
                <h1><a href="<?php echo esc_url(home_url('/')); ?>"></a>
                    <a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo esc_url(get_theme_file_uri('img/logo2-wit.webp')); ?>" alt="logo madelies" class="img-fluid"></a>
                </h1>
            </div>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown">
                        <a href="#"><span>webshop</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <?php
                            wp_nav_menu(array(
                                'theme_location' => 'primary-menu',
                                'container' => false,
                                'items_wrap' => '%3$s', // Alleen de <li>'s worden getoond
                                'fallback_cb' => false
                            ));
                            ?>
                        </ul>
